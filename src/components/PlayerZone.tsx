...
export function PlayerZone({
  ...
  return (
    <div
      ...
      } ${isYourTurn ? 'zone-your-turn-pulse' : ''} ${padding}`}
    >
      ...
      {showHandModal && isYou && (
        ...
        >
          <div
            className="bg-felt border-2 border-cedar/50 rounded-2xl shadow-xl w-full max-w-4xl max-h-[85vh] flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex flex-col gap-1 p-3 border-b border-cedar/30">
            ...
            <div className="p-3 border-t border-cedar/30 flex flex-wrap items-center gap-2">
