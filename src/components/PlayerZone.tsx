  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-2">
        <span className={`font-medium text-cedar-dark ${!isYou ? 'text-xs' : ''}`}>
        ...
        <div
          ...
          >
            ...
            {isYou ? (
              ...
              <div className="flex gap-0.5 sm:gap-1 items-center min-w-0 overflow-x-auto overflow-y-visible flex-1">
                {sortCardsByDisplayOrder(player.visibleCards).map((c) => (
