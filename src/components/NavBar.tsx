...
export function NavBar({ currentView, onNavigate, onNewGame }: NavBarProps) {
  return (
    <nav
      className="flex items-center justify-between w-full px-4 py-3 min-h-[52px] sm:min-h-0 bg-setup-header border-b-4 border-b-lebanon-red shadow-sm flex-wrap gap-2"
