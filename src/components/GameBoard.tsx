...
export function GameBoard() {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-play-area">
      ...
      <header className="relative z-30 shrink-0 flex justify-between items-center px-4 py-3 sm:py-2 gap-2 bg-black/20 backdrop-blur-sm border-b border-cedar/30 flex-nowrap sm:flex-wrap">
          ...
          <div className="relative">
            ...
            {mobileMenuOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-1 z-50 w-56 rounded-xl bg-felt border-2 border-cedar/50 shadow-xl py-2 text-cedar-dark">
                  <button
                    type="button"
